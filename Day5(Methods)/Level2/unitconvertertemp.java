...
class unitconvertertemp {
    ...
    public static void main(String[] args) {
        System.out.println("Fahrenheit to Celsius: " + convertFahrenheitToCelsius(100));
        ...
        System.out.println("Liters to Gallons: " + convertLitersToGallons(20));
    }
}